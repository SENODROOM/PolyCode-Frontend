...
export default function SqlCodeChallenge({
  challenge,
  accentColor,
  isCompleted,
  onComplete,
  ...
  function runTests() {
    ...
    window.setTimeout(() => {
      ...
      setOutput({
        ...
        stdout: allPassed ? "Query executed successfully!" : "Query failed or did not meet requirements.",
      });
